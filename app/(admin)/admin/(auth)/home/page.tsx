...
const HomePage = () => {
    ...
    const { register, handleSubmit, setValue, control, formState: { errors }, watch } = useForm<SystemFormProps>();
    ...
    const fetchHomeData = async () => {
        try {
            ...
            if (response.ok) {
                ...
                setValue("bannerStyle", data.data.bannerStyle);
                setValue("bannerImage", data.data.bannerImage);
                setValue("bannerVideo", data.data.bannerVideo);
                setValue("bannerImageAlt", data.data.bannerImageAlt);
                setValue("posterImage", data.data.posterImage);
                setValue("bannerTitle", data.data.bannerTitle);
                setValue("bannerDescription", data.data.bannerDescription);
                ...
                <AdminItemContainer>
                    ...
                    <div className='p-5 rounded-md flex flex-col gap-5'>
                        ...
                        <div className='border p-2 rounded-md'>
                            <div className='grid grid-cols-2 gap-2 relative border-b py-5 last:border-b-0'>
                                {watch("bannerStyle") === "image" ? <div className='flex flex-col gap-2'>
                                    ...
                                    />
                                    {errors.bannerVideo && (
                                        <p className="text-red-500">{errors.bannerVideo.message}</p>
                                    )}
                                </div>
                                    ...
                                    <div className='flex flex-col gap-2'>
                                        ...
                                        />
                                        {errors.posterImage && <p className='text-red-500'>{errors.posterImage.message}</p>}
                                    </div>
                                </div>}
                                <div className='flex flex-col gap-2'>
                                    <div className='flex flex-col gap-2'>
                                        <Label className='font-bold'>Title</Label>
                                        <Input type='text' placeholder='Title' {...register("bannerTitle", {
                                    ...
                                    <div className='flex flex-col gap-2'>
                                        ...
                                        <Textarea placeholder='Description' {...register("bannerDescription")} />
