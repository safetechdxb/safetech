...
>
  ...
  whileInView="show"
  viewport={{ once: true, amount: 0.2 }}
      className="grid grid-cols-1  w-full mb-4 lg:mb-[30px]"
    >
          ...
          {["Male", "Female", "Others"].map((gender, i) => (
            <label key={i} className="inline-flex items-center cursor-pointer mr-3">
              <input
                ...
                className="appearance-none w-5 h-5 border-2 border-primary rounded-full checked:bg-primary checked:border-primary transition duration-200"
              />
  ...
  whileInView="show"
  viewport={{ once: true, amount: 0.2 }}
        className="grid grid-cols-1 lg:grid-cols-2 gap-x-4 lg:gap-x-6 xxl:gap-x-10   gap-y-4 lg:gap-y-[30px] " >
...
/>
    ...
    >
      <label
        htmlFor="file-upload"
        className="cursor-pointer bg-[#1E1E1E1A] p-6   shadow-sm flex items-center  w-full"
      >
        <div className="text-2xl text-secondary opacity-50">
          {/* Your SVG icon here */}
        </div>
              <div className="text-sm text-[gray-700] flex items-center justify-left gap-2">
                <Image src={assets.note} alt="note"  />
          <p>
            {fileName || (
              <span className="text-secondary opacity-50  font-400 text-[16px]">
  ...
  whileInView="show"
  viewport={{ once: true, amount: 0.2 }}
  className="mt-6 flex w-[150px] cursor-pointer overflow-hidden group transition duration-300 ml-auto"
>
