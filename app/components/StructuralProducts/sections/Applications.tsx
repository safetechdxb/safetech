                          ...
                          <div key={item.id} className="lg:flex items-center">
                            ...
                            <div className="w-full lg:w-1/2 pr-0 lg:pr-[44px] mt-6 lg:mt-0 ">
                              ...
                              <div  >
                                ...
                                <p className="text-32 font-semibold leading-[1] mb-6 opacity-75 lg:mb-10 text-secondary capitalize">  {item.title}</p>
                                <p className="text-20 leading-[1.3] text-[#ieieie] opacity-75 font-normal mb-6 lg:mb-10 ">  {item.desc}</p>
                                <ul>
                                  {item.list.map((list, index) => (
                                    <li key={index} className="flex items-start gap-3 text-20   text-[#ieieie] opacity-75 font-normal last:mb-0  mb-5 leading-[1.3]">
                                    <Image src={assets.tick} alt="" width={20} height={20} />
                                    <span className="text-20 leading-[1.3] text-[#ieieie] opacity-75 font-normal  ">{list}</span>
                                  </li>
                                  ))}
                                  </ul>
                                </div>
