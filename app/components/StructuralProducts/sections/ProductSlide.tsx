...
const ProductSlide: React.FC<PlatformsSectionProps> = ({ data }) => {
  ...
  useEffect(() => {
    if (swiperRef.current) {
      setHoveredIndex(swiperRef.current.activeIndex);
    }
  }, []);
        ...
        <div className="flex">
          <Swiper
            ...
            onSwiper={(swiper) => {
              ...
              setHoveredIndex(swiper.activeIndex); // ensure active slide is shown on init
            }}
              ...
              >
                ...
                >
                  ...
                  <div className="p-5 transition-all duration-500 ease-in-out w-full absolute bottom-0 z-10">
                    ...
                    <div
                      className="text-white overflow-hidden relative top-2 text-[16px] leading-[1.3] transition-all duration-500 ease-in-out max-w-[3xl]"
                      style={{
                        maxHeight:
                          hoveredIndex === index
                            ? `${conRefs.current.get(slide.id)?.scrollHeight || 0
                            }px`
                            : "0px",
                      }}
                      ref={(el) => {
                        if (el) {
                          ...
                          conRefs.current.delete(slide.id);
                        }
                      }}
                    >
