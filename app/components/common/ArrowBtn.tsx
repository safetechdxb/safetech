...
const ArrowBtn = ({ btnText, btnLInk }: ArrowBtnProps) => {
  return ( 
   <Link href={btnLInk} className="flex items-center gap-3 mt-4 bg-transparent border-b-2 border-primary hover:text-white transition duration-300 py-2 w-fit group">
      <span className="text-red-600 text-14 font-semibold uppercase group-hover:text-secondary transition-color duration-200">{btnText}</span>
