...
const ArrowBtn = ({ btnText }: ArrowBtnProps) => {
  return ( 
   <button className="flex items-center gap-3 mt-4 bg-transparent border-b-2 border-primary hover:text-white transition duration-300 py-2 w-fit group">
