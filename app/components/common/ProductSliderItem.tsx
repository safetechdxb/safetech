  ...
  return ( 
    <motion.div variants={moveUp(prdId * 0.3)} initial="hidden" whileInView="show" viewport={{once:true, amount:0.2}}>
      <div className="relative w-full h-[15em] 2xl:h-[388px] mb-4 group">
        ...
        <div className="absolute bottom-0 left-0 bg-off-white w-[64px] h-[64px] group-hover:w-[128px] group-hover:bg-primary duration-200 transition-all flex items-center justify-end">
          <Link className="w-full h-[64px] flex justify-center items-center absolute top-0 left-0 duration-200 transition-all" href={prdLink}></Link>
