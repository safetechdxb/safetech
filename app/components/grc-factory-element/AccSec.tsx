  ...
  return (
    <section className="py-140 bg-off-white">
      <div className="container">
        ...
        <div className="flex flex-wrap lg:flex-nowrap gap-y-10 lg:gap-15">
            ...
            {data.thirdSection.items.map((da, index) => (
              <motion.div key={index}
                ...
                <AnimatePresence mode="wait">
                  {activeIndex === index && (
                    <>
                      <Image src={data.thirdSection.items[activeIndex].image} alt={data.thirdSection.items[activeIndex].imageAlt}
                        className="lg:hidden mt-4 w-full h-full object-cover" width={600} height={600} />
          ...
          <motion.div variants={moveUp(0.3)} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} className="relative hidden lg:flex w-full lg:w-3/7">
            <div className="h-full" >
              <figure className="image-wrapper h-full ">
                <Image src={data.thirdSection.items[activeIndex].image} alt={data.thirdSection.items[activeIndex].imageAlt} 
                className="w-full h-full object-cover" width={600} height={600} />
              </figure>
            </div>
