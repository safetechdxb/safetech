          ...
          <motion.div variants={moveUp(0.3)} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} className="relative w-full lg:w-3/7">
            ...
            <div className="h-full" >
              <figure className="image-wrapper h-full ">
                <Image src={data.thirdSection.items[activeIndex].image} alt={data.thirdSection.items[activeIndex].imageAlt} className="w-full h-full object-cover" width={600} height={600} priority />
              </figure>
            </div>
