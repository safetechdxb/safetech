      ...
      <div className="container ">
        ...
        <div className='bg-off-white p-5'>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 2xl:gap-20 items-center">
            <motion.div variants={moveUp(0.3)} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} className='bg-exlight-gray w-full h-full flex justify-center p-2'>
              <div className="w-full h-full py-14">
                <Image src={data.forthSection.image} alt={data.forthSection.imageAlt} width={605} height={286} className='w-full h-full'></Image>
              </div>
            </motion.div>
